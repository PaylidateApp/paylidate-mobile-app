...
const Settings = () => {
  ...
  const { name, email, username, phone, avatar, verified } = userData;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView
        ...
        <View style={styles.screentitlewrapper}>
          <TouchableOpacity onPress={() => navigation.navigate('Home')} style={styles.historybtn}>
        ...
        <View style={styles.screentitlewrap}>
          ...
          <TouchableOpacity style={styles.verifybtn} onPress={navigate_verifyme}>
            {!verified == true ? <Text style={styles.verifymetext}>Verify me</Text> : <Text style={styles.verifymetext}>Verified</Text>}
          </TouchableOpacity>
        </View>
        ...
        <ScrollView>
            ...
            displayProfile && <View style={styles.optionsettings}>
              ...
              <View style={styles.profilepiccontainer}>
                <Image
                  ...
                  source={require("../../assets/userProfile/userPic.png")}
                />
              ...
              <TextInput style={styles.usernameinputbox} placeholder="Name" value={name}>
              </TextInput>

              <Text style={styles.label}>User name</Text>

              <TextInput style={styles.usernameinputbox} placeholder="@username" value={username}>
              </TextInput>
          ...
          {displayContact &&
            <View style={styles.optionsettings}>
              ...
              <TextInput style={styles.usernameinputbox} value={email}>

              </TextInput>

              <Text style={styles.label}>Phone Number</Text>

              <TextInput style={styles.usernameinputbox} value={phone}>
